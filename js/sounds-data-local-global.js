// Datos de sonidos con URLs locales (versión global para compatibilidad)
const SOUNDS_DATA = [
  {
    "id": 1,
    "name": "Hornet GIT GUD",
...
// Categorías con metadatos
const CATEGORIES = {
  all: { name: 'Todos', color: '#6366f1', icon: '🎵' },
  hornet: { name: 'Hornet', color: '#e74c3c', icon: '🕷️' },
  grub: { name: 'Grub', color: '#2ecc71', icon: '🐛' },
  grimm: { name: 'Grimm', color: '#c0392b', icon: '🦇' },
  dung_defender: { name: 'Dung Defender', color: '#d68910', icon: '💩' },
  otros: { name: 'Otros', color: '#95a5a6', icon: '⚔️' }
};

// Emojis aleatorios para los botones
const BUTTON_EMOJIS = [
  '⚔️', '🗡️', '🛡️', '👑', '💎', '🌟', '✨', '⭐', 
  '🔥', '💫', '🌙', '☄️', '💀', '👻', '🕷️', '🐛',
  '🦇', '🔮', '💜', '🖤', '💙', '💚', '❤️', '🧡'
